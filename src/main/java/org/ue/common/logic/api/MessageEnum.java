...
public enum MessageEnum {
	...
	TOWN_DELETE("town_delete"), TOWN_CREATE("town_create"), RENT_REMINDER("rent_reminder"), RENT_RENRED("rent_rented"),
	...
	JOBINFO_BREEDPRICE("jobinfo_breedprice"), JOBLIST_INFO("joblist_info"), JOB_LEFT("job_left"), JOB_JOIN("job_join"),
	CONFIG_CHANGE("config_change"), MONEY_INFO("money_info"), MYJOBS_INFO("myjobs_info"), HOME_INFO("home_info"),
	CREATED("created"), DELETED("deleted"), ADDED("added"), REMOVED("removed"), RESTART("restart"), BANK("bank"),
	GOT_MONEY_WITH_SENDER("got_money_with_sender"), GAVE_MONEY("gave_money"), GOT_MONEY("got_money");
