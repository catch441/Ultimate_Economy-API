package org.ue.economyplayer.logic;

public enum EconomyPlayerExceptionMessageEnum {

	PLAYER_IS_ALREADY_OWNER("player_is_already_owner"), YOU_HAVE_NO_PERMISSION("you_have_no_permission"),
	WILDERNESS("wilderness"), NO_PERMISSION_ON_PLOT("no_permission_on_plot"), JOB_ALREADY_JOINED("job_already_joined"),
	...
	INVENTORY_SLOT_EMPTY("inventory_slot_empty"), MAX_REACHED("max_reached"),
